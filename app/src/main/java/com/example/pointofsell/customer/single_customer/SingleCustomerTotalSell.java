...
public class SingleCustomerTotalSell {
    @SerializedName("due")
    @Expose
    private Integer due;
    ...
    @Expose
    private List<SingleCustomerProduct> products = null;
    ...
    public List<SingleCustomerProduct> getProducts() {
        return products;
    }

    public void setProducts(List<SingleCustomerProduct> products) {
